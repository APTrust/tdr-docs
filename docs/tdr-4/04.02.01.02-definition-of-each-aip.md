...
description: >-
  The repository shall have a definition of each AIP that is adequate for long
  term preservation, enabling the identification and parsing of all the
  required…
number: "4.2.1.2"
...
See the APTrust [Definition of AIP](../oais/02.02-definition-of-aip.md), in particular, sections [Preservation Description Information (PDI)](../oais/02.02-definition-of-aip.md#preservation-description-information-pdi) and [Transforming SIPs into AIPs](../oais/02.02-definition-of-aip.md#transforming-sips-into-aips).
