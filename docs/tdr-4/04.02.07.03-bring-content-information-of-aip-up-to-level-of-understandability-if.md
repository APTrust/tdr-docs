...
description: >-
  The repository shall bring the Content Information of the AIP up to the
  required level of understandability if it fails the understandability
  testing.
number: "4.2.7.3"
...
- Defined depositor responsibility aligned with the [Knowledge Base of the Designated Community](../oais/02.01-designated-community.md),
