...
The information persists in a database accessible through the WebUI and REST API in addition to being attached as metadata to all stored objects. Documentation on the WebUI and REST API can be found here: [Member API](https://docs.aptrust.org/api/).
