...
APTrust maintains documented preservation strategies relevant to its holdings through its [Preservation Policy](https://aptrust.org/resources/policies/#preservation-policy), its [Risk Management, Threats, and Mitigations](https://aptrust.org/documentation-page/security/risk-management-threats-and-mitigations/) internal documentation, and its OAIS documentation defining [SIPs](../oais/02.04-definition-of-sip.md), [AIPs](../oais/02.02-definition-of-aip.md), and [DIPs](../oais/02.03-definition-of-dip.md). These documents collectively describe how APTrust ensures long-term integrity, authenticity, and retrievability of preserved digital content.
