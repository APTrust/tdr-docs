...
APTrust maintains documented preservation strategies relevant to its holdings through its [Preservation Policy](https://aptrust.org/resources/policies/#preservation-policy), its [Risk Management, Threats, and Mitigations](https://aptrust.org/documentation-page/security/risk-management-threats-and-mitigations/) (APTrust staff only; supplied to auditors on request) internal documentation (APTrust staff only; supplied to auditors on request), and its OAIS documentation defining [SIPs](../oais/02.04-definition-of-sip.md), [AIPs](../oais/02.02-definition-of-aip.md), and [DIPs](../oais/02.03-definition-of-dip.md). These documents collectively describe how APTrust ensures long-term integrity, authenticity, and retrievability of preserved digital content.
...
The division of responsibilities is described in [Risk Management documentation](https://aptrust.org/documentation-page/security/risk-management-threats-and-mitigations/) (APTrust staff only; supplied to auditors on request) and further articulated in APTrust’s public explanation of the [shared responsibility model](https://aptrust.org/2025/02/24/embracing-the-shared-responsibility-model-in-digital-preservation/) (February 2025). That explanation clarifies that:
