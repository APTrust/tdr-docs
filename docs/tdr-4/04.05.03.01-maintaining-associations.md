...
Also see the [Definition of AIPs](../oais/02.02-definition-of-aip.md), the subsection [Transforming SIPs into AIPs](../oais/02.02-definition-of-aip.md), and [Monitoring](https://aptrust.org/documentation-page/security/2-0-monitoring-and-audit/monitoring/) (APTrust members only; supplied to auditors on request) for additional information.
