...
SIPs, represented by the original bag file, are deleted after processing. The process is described in the documentation on [Definition of an AIP](../oais/02.02-definition-of-aip.md) and its subsection [Transforming SIPs into AIPs](../oais/02.02-definition-of-aip.md#transforming-sips-into-aips). It is also documented in the [APTrust Preservation Services User Guide](https://aptrust.github.io/preserv-docs/workers/ingest/cleanup/).
