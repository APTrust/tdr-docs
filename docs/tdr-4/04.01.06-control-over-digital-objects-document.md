---
title: "4.1.6 Control over digital objects"
description: >-
  The repository shall obtain sufficient control over the Digital Objects to
  preserve them.
number: "4.1.6"
sequence: "04.01.06"
...
As described in [Definition of AIP](../oais/02.02-definition-of-aip.md), the file transfer content is initially uploaded to the member’s Amazon Web Services S3 [receiving bucket](https://docs.aptrust.org/user-guide/glossary/#aptrust-and-preservation-terms). From there, the content is replicated to an APTrust working environment, from which it is ingested into the storage environment.

Responsibility for physical control transfers when the content is replicated into the APTrust working environment. Responsibility for preservation transfers when the content is ingested into the APTrust storage environment as described in the [Definition of AIP](../oais/02.02-definition-of-aip.md) (see also [3.5.1.3](../tdr-3/03.05.01.03-policies-about-preservation-responsibility.md)).
...
The physical and informational security measures are outlined in [5.1.1.2](../tdr-5/05.01.01.01.02-procedures-in-place-to-monitor-and-receive-notifications.md).
