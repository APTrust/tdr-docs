...
APTrust saves all data objects as Generic Files. Each Generic File has a file format attribute containing file type information. See the section [Generic Files](https://docs.aptrust.org/user-guide/glossary/#registry-terms)  for more information.
