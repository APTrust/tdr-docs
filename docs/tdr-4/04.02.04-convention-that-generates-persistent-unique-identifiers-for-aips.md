...
The APTrust naming conventions are documented in the APTrust User Guide, when describing PREMIS events for [objects](https://docs.aptrust.org/user-guide/registry/events/) and [files](https://docs.aptrust.org/user-guide/registry/events/#file-level-events).
