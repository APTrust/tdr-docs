...
description: >-
  The repository shall have documented processes for acquiring Preservation
  Description Information (PDI) for its associated Content Data Object and
  acquire PDI…
number: "4.2.6"
sequence: "04.02.06"
...
APTrust maintains documented processes for acquiring, generating, preserving, and associating Preservation Description Information (PDI) with its Content Data Object. These processes are defined in the APTrust BagIt Profile and [Bagging Requirements](https://docs.aptrust.org/user-guide/depositing/), the [APTrust User Guide](https://docs.aptrust.org/user-guide/) (Ingest, Updates, and Restoration), [PREMIS Events documentation](https://docs.aptrust.org/user-guide/registry/events/), and related Registry workflow documentation.
...
[Definition of AIP](../oais/02.02-definition-of-aip.md) describes the PDI associated with each intellectual object and provides the details of PDI generation during the creation of that object.
