...
The results of various ingest content processing workflows as well as details about reporting to the Depositors are described in the [Ingest](https://docs.aptrust.org/user-guide/preservation/ingest/), [PREMIS Events](https://docs.aptrust.org/user-guide/registry/events/), and [Reports](https://docs.aptrust.org/user-guide/registry/reports/) sections of the APTrust User Guide. PREMIS Events document acquisition. Also see section [4.1.7](04.01.07-communication-with-producer-depositor.md) on communication with the depositors.
