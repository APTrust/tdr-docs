...
description: >-
  The repository shall have a system of reliable linking/resolution services
  in order to find the uniquely identified object, regardless of its physical
  location.
number: "4.2.4.2"
...
![A PREMIS event record showing the semantic identifier (Outcome Detail) being assigned to an intellectual object.](../img/PREMIS_event.png)
