...
description: >-
  The repository shall comply with Access Policies. How APTrust enforces
  access policies and logs access management failures and anomalies.
number: "4.6.1"
sequence: "04.06.01"
...
APTrust has a documented matrix for access to metadata, which can be found in the section [Types of access for APTrust Staff](https://docs.aptrust.org/registry-docs/security/roles/). For all other types of content only APTrust staff and the original depositor have access.

The [Security](https://aptrust.org/documentation-page/security/) (APTrust members only; supplied to auditors on request) section describes controls and management of authentication/authorization. The types of authorized and unauthorized access are explained in [Authentication & Administration](https://aptrust.org/documentation-page/security/authentication-administration/) (APTrust members only; supplied to auditors on request).
