...
The Representation Information necessary to make each Data Object understandable exists in the form of a Generic File file\_format attribute. See [4.2.5](04.02.05-tool-and-resources-to-provide-authoritative-representation.md) and [Member API](https://docs.aptrust.org/api/) for additional information.
