...
APTrust performs fixity checking on hot copies of individual files every 180 days. [Fixity checks](https://docs.aptrust.org/api/) do not alter the AIP or any of its component files. Failed fixity checks generate alerts to both APTrust staff and the depositing institution.
