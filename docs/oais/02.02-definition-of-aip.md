...
An APTrust member institution will prepare a SIP according to the [APTrust Bag-It Specification](https://docs.aptrust.org/user-guide/depositing/).
...
1. 1. APTrust member institution uploads a SIP (tarred bag) to an Amazon Web Services bucket assigned to the member institution (receiving bucket).
   ...
   3. APTrust will create an intellectual object for the SIP and assign a unique identifier. APTrust extracts the SIP (tarred bag) and indexes supported fields as described in the User Guide. [Generic file](https://docs.aptrust.org/api/) records are created for each file within the object’s data directory, assigning a unique identifier for each file. Each file will undergo characterization via Siegfried to generate representation information that is indexed.
...
- - OAIS (2012) CCSDS 650.0-M-2: Reference Model for an Open Archival Information System (OAIS). Magenta Book. Issue 1. June 2012 (ISO 14721:2003) [CCSDS 650.0-M-2 (PDF)](https://public.ccsds.org/pubs/650x0m2.pdf) accessed 2017-07-06
  ...
  - [Intellectual Object resource documentation](https://docs.aptrust.org/user-guide/glossary/#registry-terms)
  - [Generic File resource documentation](https://docs.aptrust.org/user-guide/registry/files/)
