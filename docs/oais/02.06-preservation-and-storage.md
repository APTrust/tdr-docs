...
Content preserved by APTrust is stored in a combination of [S3, S3 Glacier, and S3 Glacier Deep Archive](https://aptrust.org/documentation-page/system-infrastructure/storage/) (APTrust staff only; supplied to auditors on request) for redundancy, mitigation against failure in a particular storage layer, and geographic redundancy. The APTrust High Assurance storage class, the default, and oldest offering combines S3 and S3 Glacier.
