...
description: >-
  APTrust preservation and storage goals, the S3 and Glacier layers behind
  each storage class, and the checksum requirements applied to preserved
  content.
sequence: "02.06"
...
Content preserved by APTrust is stored in a combination of [S3, S3 Glacier, and S3 Glacier Deep Archive](https://aptrust.org/documentation-page/system-infrastructure/storage/) (APTrust members only; supplied to auditors on request) for redundancy, mitigation against failure in a particular storage layer, and geographic redundancy. The APTrust High Assurance storage class, the default, and oldest offering combines S3 and S3 Glacier.
...
- [Bagging (SIP) Requirements](https://docs.aptrust.org/user-guide/depositing/)
