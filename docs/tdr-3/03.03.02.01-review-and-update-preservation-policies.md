...
description: >-
  The repository shall have mechanisms for review, update, and ongoing
  development of its Preservation Policies as the repository grows and as
  technology and…
number: "3.3.2.1"
...
![Excerpt of an APTrust policy document showing a Review section — review frequency every four years, next review January 2029 — above a Version History table. The table records versions 0.1 through 3.5 from September 2015 to January 2025, each with status, date and notes covering drafts, staff and Advisory reviews, Board votes and DOI uploads.](../img/version-history-example.png)
