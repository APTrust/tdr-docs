...
description: >-
  The repository shall have procedures in place to monitor and receive
...
![Screenshot of an AWS CloudWatch dashboard panel titled Network RX, charting bytes per second for APTrust preservation services over a three-hour window. A tooltip ranks the ten busiest services at a selected moment, led by the ingest staging uploader.](../img/Picture3.png)
