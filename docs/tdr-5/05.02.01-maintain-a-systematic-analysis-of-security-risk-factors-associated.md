...
A detailed description of the APTrust threat model and mitigations are documented here: [Risk Management, Threats, and Mitigations](https://aptrust.org/documentation-page/security/risk-management-threats-and-mitigations/) (APTrust members only; supplied to auditors on request)
