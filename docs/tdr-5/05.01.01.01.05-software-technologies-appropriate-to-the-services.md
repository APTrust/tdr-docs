...
APTrust staff actively develops the web front-end software “[Registry](https://docs.aptrust.org/registry-docs/)”,  as well as supporting preservation service infrastructure  “[Preservation Services](https://docs.aptrust.org/preservation-services-docs/)”, and the software developed by APTrust is released under Apache License (ASL)[[1]](https://wiki.aptrust.org/5.1.1.1.5_Software_technologies_appropriate_to_the_services_it_provides_to_its_designated_communities#cite_note-1). The recently updated system is now a loosely-coupled [container based microservices architecture](https://docs.aptrust.org/preservation-services-docs/overview/) running on the AWS container (**PaaS**) platform ECS Fargate. The application is built using open source technologies, such as [Go](https://docs.aptrust.org/preservation-services-docs/overview/) and [Postgres](https://aws.amazon.com/rds/postgresql/what-is-postgresql/#:~:text=PostgreSQL%20is%20an%20advanced%2C%20enterprise,(non%2Drelational)%20querying.) Storage media is hosted on multiple types – Glacier, S3 – on multiple Public Clouds, in multiple US regions.
