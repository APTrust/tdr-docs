...
This [alarm can also be viewed in the AWS Management Console](https://us-east-1.console.aws.amazon.com/cloudwatch/deeplink.js?region=us-east-1#alarmsV2:alarm/mid-tier-prod-RDSAlarmCPUHigh-UBN3S8J42LNZ) (APTrust staff only; supplied to auditors on request).
