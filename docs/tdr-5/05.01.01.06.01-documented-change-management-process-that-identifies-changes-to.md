...
AWS’ [CloudTrail](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/how-cloudtrail-works.html) logs all API calls and Console activities, indicating when changes are made to the infrastructure, identities and other critical items in a detailed audit log. These logs show time, resource, and systems changes, and the entity that made the change. The log includes the last 7 days of API activity for supported services, but is archived in an S3 bucket for future auditing purposes.
