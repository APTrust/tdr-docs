...
The threat of a natural disaster or other cataclysmic event is analyzed, and described in the Natural Disaster section of [Risk Management, Threats, and Mitigations](https://aptrust.org/documentation-page/security/risk-management-threats-and-mitigations/) (APTrust members only; supplied to auditors on request). However, this is somewhat dated, and will require a complete replacement, based on more modern standards, and the new architecture. Work has begun on this process, and it will be based on the agnostic Cloud Security Alliance (CSA) matrix for the areas identified. It will be re-pointed when complete.

The delineated roles and responsibilities have been documented in the [Security](https://aptrust.org/documentation-page/security/) (APTrust members only; supplied to auditors on request) section as well as the [APTrust Staff](https://aptrust.org/about/staff/) section and section [3.2.1](../tdr-3/03.02.01.01-identified-and-established-duties.md). This will be updated to the new environment.
...
As an actual response, an [APTrust Disaster Recovery and Management](https://docs.google.com/document/u/0/d/1-QvMPKiFEo2WuoN6oLvrWqtINKLuJQSW3LrECvZXEMg/edit) plan (APTrust members only; supplied to auditors on request) covering incident management has been created. This is current and valid to DR.
