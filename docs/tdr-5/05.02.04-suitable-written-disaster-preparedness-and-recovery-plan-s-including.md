...
The delineated roles and responsibilities have been documented in the [Security](https://aptrust.org/documentation-page/security/) (APTrust members only; supplied to auditors on request) section as well as the [APTrust Staff](https://aptrust.org/staff/) section and section [3.2.1](../tdr-3/03.02.01.01-identified-and-established-duties.md). This will be updated to the new environment.
