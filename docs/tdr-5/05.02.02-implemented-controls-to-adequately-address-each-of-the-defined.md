...
Threat model and mitigations are documented here: [Risk Management, Threats, and Mitigations](https://aptrust.org/documentation-page/security/risk-management-threats-and-mitigations/) (APTrust staff only; supplied to auditors on request)
