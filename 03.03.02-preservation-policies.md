...
breadcrumb: "Trusted Digital Repository (TDR – ISO 16363) > TDR 3.0 Organizational Infrastructure > 3.3.2 Preservation policies"
...
See the [Preservation Policy](https://aptrust.org/resources/policies/#preservation-policy) and [Collection Strategy Policy](https://aptrust.org/resources/policies/#collection-strategy-policy) for a description of ingest requirements. Also, see the page on [Preservation and Storage](02.06-preservation-and-storage.md) for specific details on the preservation environment.
