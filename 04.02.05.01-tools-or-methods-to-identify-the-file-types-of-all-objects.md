---
title: "4.2.5.1 Tools or methods to identify the file types of all objects"
number: "4.2.5.1"
sequence: "04.02.05.01"
section: "TDR 4.0 Digital Object Management"
breadcrumb: "Trusted Digital Repository (TDR – ISO 16363) > TDR 4.0 Digital Object Management > 4.2.5.1 Tools or methods to identify the file types of all objects"
source_url: https://aptrust.org/documentation-page/tdr-4-0-digital-object-management/4-2-5-1-tools-or-methods-to-identify-the-file-types-of-all-objects/
...
APTrust saves all data objects as Generic Files. Each Generic File has a file format attribute containing file type information. See the section [Generic Files](https://aptrust.github.io/userguide/glossary/#generic-file)  for more information.
