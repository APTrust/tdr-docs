...
breadcrumb: "Trusted Digital Repository (TDR – ISO 16363) > TDR 3.0 Organizational Infrastructure > 3.3.5 Information integrity measurements"
...
The process for verifying and providing fixity checks can be found in the APTrust [Preservation & Storage](02.06-preservation-and-storage.md) documentation. The Member generates the MD5 checksum as part of their bagging process, and APTrust generates a SHA256 checksum, in addition to others, such as SHA-512, for future use cases.
