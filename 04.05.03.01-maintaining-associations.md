...
breadcrumb: "Trusted Digital Repository (TDR – ISO 16363) > TDR 4.0 Digital Object Management > 4.5.3.1 Maintaining Associations"
...
As discussed in [4.5.3](04.05.03-create-bi-directional-linkages-between-each-aip-and-its-descriptive.md) and in the technical documentation on [Preservation and Storage](02.06-preservation-and-storage.md), this is an ongoing process.

Also see the [Definition of AIPs](02.02-definition-of-aip.md), the subsection [Transforming SIPs into AIPs](02.02-definition-of-aip.md), and [Monitoring](https://aptrust.org/documentation-page/security/2-0-monitoring-and-audit/monitoring/) for additional information.
