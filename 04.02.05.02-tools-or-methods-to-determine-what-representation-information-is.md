---
title: "4.2.5.2 Tools or methods to determine what Representation Information is necessary for understandability"
number: "4.2.5.2"
sequence: "04.02.05.02"
section: "TDR 4.0 Digital Object Management"
breadcrumb: "Trusted Digital Repository (TDR – ISO 16363) > TDR 4.0 Digital Object Management > 4.2.5.2 Tools or methods to determine what Representation Information is necessary for understandability"
source_url: https://aptrust.org/documentation-page/tdr-4-0-digital-object-management/4-2-5-2-tools-or-methods-to-determine-what-representation-information-is-necessary-for-understandability/
...
The Representation Information necessary to make each Data Object understandable exists in the form of a Generic File file\_format attribute. See [4.2.5](04.02.05.02-tools-or-methods-to-determine-what-representation-information-is.md) and [Member API](https://aptrust.github.io/registry/) for additional information.
