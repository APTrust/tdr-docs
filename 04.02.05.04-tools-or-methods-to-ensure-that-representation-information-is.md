---
title: "4.2.5.4 Tools or methods to ensure that Representation Information is persistently associated with objects"
number: "4.2.5.4"
sequence: "04.02.05.04"
section: "TDR 4.0 Digital Object Management"
breadcrumb: "Trusted Digital Repository (TDR – ISO 16363) > TDR 4.0 Digital Object Management > 4.2.5.4 Tools or methods to ensure that Representation Information is persistently associated with objects"
source_url: https://aptrust.org/documentation-page/tdr-4-0-digital-object-management/4-2-5-4-tools-or-methods-to-ensure-that-representation-information-is-persistently-associated-with-objects/
...
The information persists in a database accessible through the WebUI and REST API in addition to being attached as metadata to all stored objects. Documentation on the WebUI and REST API can be found here: [Member API](https://aptrust.github.io/registry/).
