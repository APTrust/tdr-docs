...
breadcrumb: "Trusted Digital Repository (TDR – ISO 16363) > TDR 4.0 Digital Object Management > 4.2.4 Convention that generates persistent, unique identifiers for AIPs"
...
![A diagram mapping the partial transformation of a member-deposited SIP into a preservation AIP, showing how semantic identifiers are constructed for objects and files.](https://aptrust.org/wp-content/uploads/2025/07/APTrust_Identifiers_detailed_updated.png)
...
![A screenshot of a generic file record stored in APTrust. It displays both the semantic identifier and UUID, demonstrating that the UUID is used to locate the file in preservation storage.](https://aptrust.org/wp-content/uploads/2025/07/Generic_file.png)
